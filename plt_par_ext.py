...
# ===========================================================
# DEFINE YOUR REGION HERE — just change these four numbers!
...
# Time → decimal years (same as before)
def to_year(t):
...
# Nice title that tells the user which region is plotted
...
plt.xlim(2015, 2070)
plt.ylim(anomaly.min() - 0.5, anomaly.max() + 0.5)   # auto-scale a bit
